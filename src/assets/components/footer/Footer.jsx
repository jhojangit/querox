...
const Footer = () => {
    return (
        <div className='container__footer'>
            ...
            <div className="whats">
                <a target="_blank" aria-label="Compra por WhatsApp" href="https://wa.me/573223250286?text= ¡Hola! Quisiera comprar un producto"> <i className='bx bxl-whatsapp bx-lg bx-tada'></i> </a>
            </div>
