...
const Footer = () => {
    return (
        <div className='container__footer'>
            ...
            <div className="whats">
                <a target="_blank" aria-label="Compra por WhatsApp" href="https://wa.me/573204102059?text= ¡Hola! Quisiera averigurar un producto"> <i class='bx bxl-whatsapp bx-lg'></i> </a>
            </div>
